...
\par For the next 4 tutorials, we will be taking advantage of the great online resources that working with the Arduino provides. Please watch all the videos and simply follow the instructions provided to build the small projects each video has. These should be easy, straightforward, and get you familiar with the Arduino environment.

\subsection*{Tutorial 4}
\par \verb http://www.youtube.com/watch?v=fCxzA9_kg6s
\par 
...
\par \verb http://arduino.cc/en/Guide/MacOSX 
\par \verb http://arduino.cc/en/Guide/windows
\par If you are using Linux, you won’t need me to tell you how to get it installed.

\subsection*{Tutorial 5}
\par \verb http://www.youtube.com/watch?v=_LCCGFSMOr4
...
\par \verb http://www.youtube.com/watch?v=abWCy_aOSwY
...
\par \verb http://www.youtube.com/watch?v=js4TK0U848I
\par 
